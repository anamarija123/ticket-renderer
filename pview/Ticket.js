...
function previewTicket()
{
    ...
    var inputFile = renderer.RendererContextInfo.getFilesInfoFromTicket(scriptLines);
    var contextDictionary = context.TransactionContext.readFromInputFile(inputFile);
